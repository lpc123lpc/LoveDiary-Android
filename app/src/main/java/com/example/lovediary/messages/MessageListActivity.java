package com.example.lovediary.messages;
...
import com.example.lovediary.models.DefaultUser;
import com.example.lovediary.models.MyMessage;
import com.example.lovediary.views.ChatView;
...
public class MessageListActivity extends Activity implements View.OnTouchListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public boolean onSendTextMessage(CharSequence input) {
                ...
                message.setUserInfo(new DefaultUser("1", "Girl", "R.drawable.girl"));
    ...
    private List<MyMessage> getMessages() {
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (i % 2 == 0) {
                ...
                message.setUserInfo(new DefaultUser("0", "Boy", "R.drawable.boy"));
            } else {
    ...
    private void initMsgAdapter() {
        ...
        voiceMessage.setUserInfo(new DefaultUser("0", "Boy", "R.drawable.boy"));
        ...
        sendVoiceMsg.setUserInfo(new DefaultUser("1", "Girl", "R.drawable.girl"));
        ...
        receiveVideo.setUserInfo(new DefaultUser("0", "Boy", "R.drawable.boy"));
