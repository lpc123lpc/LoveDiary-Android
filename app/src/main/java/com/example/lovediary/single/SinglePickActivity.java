package com.example.lovediary.single;
...
import com.example.lovediary.helper.FileSizeHelper;
import com.example.lovediary.helper.PermissionHelper;
import com.example.lovediary.helper.PickImageHelper;
import com.example.lovediary.module.ImageModule;
    ...
    private void getAvatar() {
        ...
        bmobQuery.getObject(getString(R.string.avatar_id), new QueryListener<ImageModule>() {
            ...
            public void done(ImageModule imageModule, BmobException e) {
                if(e==null){
                    Glide.with(SinglePickActivity.this).load(imageModule.getUrl()).into(new SimpleTarget<Drawable>() {
                        @Override
                ...
                public void done(BmobException e) {
                    if (e == null) {
                        ...
                        imageModule.update(getString(R.string.avatar_id), new UpdateListener() {
                            ...
                            public void done(BmobException e) {
                                if(e==null){
                                    Glide.with(SinglePickActivity.this).load(mBmobFile.getUrl()).into(new SimpleTarget<Drawable>() {
    
                                        @Override
                                        public void onResourceReady(Drawable resource, Transition glideAnimation) {
                                            mIvAvatar.setImageDrawable(resource);
                                            mPbProgress.setVisibility(View.GONE);
                                        }
                                    });
